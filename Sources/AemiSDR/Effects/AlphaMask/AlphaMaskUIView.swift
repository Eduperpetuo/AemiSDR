...
//
    ...
    open class AlphaMaskUIView: UIView {
        ...
        private func updateMask(for size: CGSize, force: Bool = false) {
            ...
            let maskImage = generateAlphaMask(size: size, scale: scale)
        ...
        private func generateAlphaMask(size: CGSize, scale: CGFloat) -> CGImage? {
            ...
            let extent = CGRect(x: 0, y: 0, width: wPx, height: hPx)
            ...
            case .linearTopToBottom:
                ...
                let args: [Any] = [wPx, hPx, configuredStartOffset, inverted]
            ...
            case .easeInTopToBottom:
                ...
                let inverted = configuredInverted ? 1.0 : 0.0
                let args: [Any] = [wPx, hPx, configuredStartOffset, 0.0, inverted]
                maskImage = AlphaMaskCache.generateCGImage(
            ...
            case .easeInBottomToTop:
                let inverted = configuredInverted ? 1.0 : 0.0
                let args: [Any] = [wPx, hPx, configuredStartOffset, 1.0, inverted]
                maskImage = AlphaMaskCache.generateCGImage(
                    kernel: AlphaMaskCache.easeInAlphaMask,
                    extent: extent,
                    arguments: args
            ...
            case .roundedRectangle:
                ...
                let inverted = configuredInverted ? 1.0 : 0.0
                let args: [Any] = [wPx, hPx, cornerRadiusPx, fadeWidthPx, inverted]
                maskImage = AlphaMaskCache.generateCGImage(
            ...
            case .easedRoundedRectangle:
                // Rounded rectangle with smooth Hermite falloff
                let cornerRadiusPx = configuredCornerRadius * scale
                let fadeWidthPx = configuredFadeWidth * scale
                let inverted = configuredInverted ? 1.0 : 0.0
                let args: [Any] = [wPx, hPx, cornerRadiusPx, fadeWidthPx, inverted]
            ...
            case .superellipseSquircle:
                // Superellipse shape (squircle) with configurable exponent
                let cornerRadiusPx = configuredCornerRadius * scale
                let fadeWidthPx = configuredFadeWidth * scale
                let inverted = configuredInverted ? 1.0 : 0.0
            ...
            case .easedSuperellipseSquircle:
                // Superellipse with smooth eased transitions
                let cornerRadiusPx = configuredCornerRadius * scale
                let fadeWidthPx = configuredFadeWidth * scale
                let inverted = configuredInverted ? 1.0 : 0.0
                let args: [Any] = [wPx, hPx, cornerRadiusPx, fadeWidthPx, configuredExponent, inverted]
